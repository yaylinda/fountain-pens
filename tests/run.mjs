...
try {
    await build({
        entryPoints: ['tests/persistence.test.ts', 'tests/collection.test.ts', 'tests/workflows.test.tsx', 'tests/save-celebration.test.ts', 'tests/http-delivery.test.mjs'],
    ...
    const result = spawnSync(
        ...
        [
            ...
            join(output, 'persistence.test.mjs'),
